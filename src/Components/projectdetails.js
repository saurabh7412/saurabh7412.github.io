export const projectArr = [
  {
    ...
    desc : `Briks99 is an Indian online real estate marketplace which is a subsidiary of Zillow. It facilitates buyers and renters to find homes and neighborhoods across the United States through recommendations, local insights, and map overlays that offer details on commutes, schools, churches, and nearby businesses.

    In this project, I have created the BACK-END as a team lead of the project and made a FULL-STACK project by manipulating dom elements using REACT, manage state changes using REDUX, CHAKRA UI Library, style using CSS in react, styled components, and tried to make a responsive website and implement dynamic routing to persist data. We have managed our database globally using MongoDB Atlas and Express.`,
  ...
  },
  {
    ...
    desc : `This E-Commerce website specializes in selling fashion products for men, women, and kids. The website provides 16,000 products of different products like shoes, jeans, shirts, kurtas, etc.
...

    {
      ...
      project_type : "Solo Project",
      duration : 4,
      tech_stack : "ReactJS | HTML | CSS | JavaScript | Chakra UI Library",
      github_link : `https://github.com/saurabh7412/ardent-shock-8310`,
      presentation_link : `https://drive.google.com/file/d/1KeqxY5i1a4XVxtRKoj7t81WRk2jeH6Qz/view`,
      deploy_link : `https://comforting-croquembouche-96cf08.netlify.app/`,
    },

    {
      ...
      desc : `This is an home decor website which speciaizes in selling Sofas for all caytegory. The website provides 33,000 products of different types Sofas,Beds, ligthing, Chairs, Almir , ShoesRack, Home Accessories.
      ...
      github_link : `https://github.com/rohansah29/entertaining-snails-6673`,
      presentation_link : `https://drive.google.com/file/d/1oE6TpSXSBv1rYqcBfluQ3UF2EpkfSeeE/view`,
    ...
    },
    {
      ...
      duration : 5,
      tech_stack : "HTML | CSS | JavaScript",
      github_link : `https://github.com/saurabh7412/dusty-record-6347`,
      presentation_link : `https://drive.google.com/file/d/1MJt-etyK95Pi2f47sE4ECjXXPOyrq7La/view`,
      deploy_link : "https://spontaneous-speculoos-88fec1.netlify.app/"
    }
